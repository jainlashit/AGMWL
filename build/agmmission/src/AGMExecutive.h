...
public:
    ...
    {
        symbolsUpdated(modification, 0);
    }
    void symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::Context& __ctx)
    {
        symbolsUpdated(modification, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_symbolsUpdated(modification, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_symbolsUpdated(modification, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_symbolsUpdated(modification, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_symbolsUpdated(modification, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification)
    {
        return begin_symbolsUpdated(modification, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::Context& __ctx)
    {
        return begin_symbolsUpdated(modification, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_symbolsUpdated(modification, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_symbolsUpdated(modification, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::RoboCompAGMExecutive::Callback_AGMExecutiveTopic_symbolsUpdatedPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_symbolsUpdated(modification, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_symbolsUpdated(const ::RoboCompAGMWorldModel::NodeSequence& modification, const ::Ice::Context& __ctx, const ::RoboCompAGMExecutive::Callback_AGMExecutiveTopic_symbolsUpdatedPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_symbolsUpdated(modification, &__ctx, __del, __cookie);
    }
...
public:
    ...
    {
        edgesUpdated(modification, 0);
    }
    void edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::Context& __ctx)
    {
        edgesUpdated(modification, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_edgesUpdated(modification, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_edgesUpdated(modification, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_edgesUpdated(modification, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_edgesUpdated(modification, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification)
    {
        return begin_edgesUpdated(modification, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::Context& __ctx)
    {
        return begin_edgesUpdated(modification, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_edgesUpdated(modification, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_edgesUpdated(modification, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::RoboCompAGMExecutive::Callback_AGMExecutiveTopic_edgesUpdatedPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_edgesUpdated(modification, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_edgesUpdated(const ::RoboCompAGMWorldModel::EdgeSequence& modification, const ::Ice::Context& __ctx, const ::RoboCompAGMExecutive::Callback_AGMExecutiveTopic_edgesUpdatedPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_edgesUpdated(modification, &__ctx, __del, __cookie);
    }
